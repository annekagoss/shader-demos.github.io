...
export default class GLScene extends Component<SceneProps> {
  ...
  componentDidMount() {
    ...
    this.transformation.translation = { ...DEFAULT_OFFSET, ...positionOffset };
    this.transformation.rotation = { ...DEFAULT_ROTATION, ...rotationOffset };
  ...
  render(): React.ReactNode {
    ...
    return (
      ...
      >
        ...
        />
        {placeholderImage && (
          <img className={styles.placeholder} src={placeholderImage} />
        )}
        <div
